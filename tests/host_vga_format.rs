use kfs::kernel::services::console::{
    format_isize_decimal, format_usize_decimal, format_usize_hex, render_printf_with_args,
    MAX_ISIZE_DECIMAL_DIGITS, MAX_USIZE_DECIMAL_DIGITS, MAX_USIZE_HEX_DIGITS,
};
