...
printf '\n'
color "1;34"; printf '%s\n' "TESTS"; reset_color
run_item 1 12 "release ISO is bootable" \
...
run_item 2 12 "release IMG is bootable" \
  bash scripts/container.sh run -- \
