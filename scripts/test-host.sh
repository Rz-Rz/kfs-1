...
printf '\n'
color "1;34"; printf '%s\n' "TESTS"; reset_color
run_item 1 13 "release ISO is bootable" \
...
run_item 2 13 "release IMG is bootable" \
  bash scripts/container.sh run -- \
